...
class Bot {
  constructor(options) {
    ...
    this.sendAsNotice = options.sendAsNotice === true; // default to false
  ...
  sendToIRC(message) {
    ...
    if (ircChannel) {
      ...
      const sendMessageToIRC = this.sendAsNotice ? this.ircClient.notice : this.ircClient.say;
      ...
      if (this.isCommandMessage(text)) {
        ...
        if (this.formatCommandPrelude) {
          ...
          sendMessageToIRC.call(this.ircClient, ircChannel, prelude);
        }
        sendMessageToIRC.call(this.ircClient, ircChannel, text);
      } else {
        if (text !== '') {
          // Convert formatting
        ...
        if (message.attachments && message.attachments.size) {
          message.attachments.forEach((a) => {
            ...
            sendMessageToIRC.call(this.ircClient, ircChannel, urlMessage);
          });
        }
      }
    }
